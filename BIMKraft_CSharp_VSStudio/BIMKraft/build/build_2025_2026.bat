@echo off
echo Building WIP Tools for Revit 2025 and 2026...
echo.
...
echo - %%AppData%%\Autodesk\Revit\Addins\2025\ICLTools.dll
echo - %%AppData%%\Autodesk\Revit\Addins\2026\ICLTools.dll
pause
